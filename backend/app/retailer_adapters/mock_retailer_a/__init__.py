"""MockRetailerA adapter package (fixture-backed mock, not a real retailer).
...
from app.retailer_adapters.mock_retailer_a.adapter import MockRetailerAAdapter
from app.retailer_adapters.mock_retailer_a.config import (
    RETAILER_ID,
    RETAILER_NAME,
    build_config,
)
...
) -> MockRetailerAAdapter:
    """Build a configured MockRetailerA adapter."""
    return MockRetailerAAdapter(
