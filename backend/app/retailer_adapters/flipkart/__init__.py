"""Flipkart adapter package (official Affiliate API).
...
from app.retailer_adapters.flipkart.adapter import FlipkartAdapter
from app.retailer_adapters.flipkart.config import RETAILER_ID, RETAILER_NAME, build_config
...
def create_adapter(
    *,
    ...
    """Build a configured Flipkart adapter."""
