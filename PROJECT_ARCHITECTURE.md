...
> Retailer integrations, matching, pricing, ML, and other later-phase business logic described
> below are still targets, not yet built. This document describes the target architecture the
